...
type ServiceDeploymentArgs struct {
	...
	UseLoadBalancer   pulumi.Bool
	Ports             pulumi.IntArrayInput
	Replicas          pulumi.IntPtrInput
}

func NewServiceDeployment(ctx *pulumi.Context, name string, args *ServiceDeploymentArgs, opts ...pulumi.ResourceOption) (pServiceDeployment *ServiceDeployment, err error) {
	serviceDeployment := &ServiceDeployment{}
	if err = ctx.RegisterComponentResource("kubernetes-go-guestbook:component:ServiceDeployment", name, serviceDeployment, opts...); err != nil {
		return nil, err
	}
